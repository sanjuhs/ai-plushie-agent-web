          ...
          <div className="mt-6">
            <div className="bg-white rounded-xl p-4 shadow-lg">
              <h3 className="text-lg font-bold text-purple-800 mb-3 text-center">
                🌤️ Squeaky&apos;s Weather Powers
              </h3>
              <div className="text-sm text-center text-purple-600 mb-3">
                Try asking Squeaky: &quot;What&apos;s the weather in
                Bengaluru?&quot;
              </div>
              <div className="text-xs text-center text-gray-500">
                Squeaky can now use function calling to check weather! 🎉
              </div>
            </div>
          </div>
        )}
